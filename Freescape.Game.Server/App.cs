...
namespace Freescape.Game.Server
{
    ...
    internal static class App
    {
        ...
        private static void BuildIOCContainer()
        {
            ...
            builder.RegisterType<EffectTrackerService>().As<IEffectTrackerService>().SingleInstance();
            ...
            builder.RegisterType<StructureService>().As<IStructureService>().SingleInstance();
